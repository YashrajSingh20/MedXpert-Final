    ...
    <div className="min-h-screen flex items-center justify-center bg-navy-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          <Link
            to="/signup/doctor"
            className="bg-navy-800 p-8 rounded-lg text-center hover:bg-navy-700 transition-colors border-2 border-transparent hover:border-accent-500"
          >
            <Stethoscope className="h-12 w-12 text-accent-500 mx-auto mb-4" />
          ...
          <Link
            ...
            className="bg-navy-800 p-8 rounded-lg text-center hover:bg-navy-700 transition-colors border-2 border-transparent hover:border-accent-500"
          >
            <Store className="h-12 w-12 text-accent-500 mx-auto mb-4" />
