    ...
    <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button 
                      ...
                      className="text-accent-400 hover:text-accent-300 p-2 rounded-full hover:bg-navy-700"
                      title="Preview"
                    >
                      <Eye size={20} />
                    </button>
                    ...
                    <button
                      ...
                      className="text-red-400 hover:text-red-300 p-2 rounded-full hover:bg-navy-700"
                      title="Delete"
                    >
                      <Trash2 size={20} />
                    </button>
              ...
              {records.map((record) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    {record.type === 'image' ? (
                      <Image className="text-accent-400" size={24} />
                    ) : (
                      <FileText className="text-accent-400" size={24} />
                    )}
                    <div>
      ...
      {previewData && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center p-4 z-50">
          <div className="bg-navy-800 rounded-lg max-w-4xl w-full max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between p-4 border-b border-navy-700">
              <h3 className="text-xl font-semibold text-white">{previewData.title}</h3>
              <button
                onClick={() => setPreviewData(null)}
                className="text-gray-400 hover:text-white p-1 rounded-full hover:bg-navy-700"
              >
                <X size={24} />
              </button>
            </div>
